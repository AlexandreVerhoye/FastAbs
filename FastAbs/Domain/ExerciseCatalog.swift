...
enum ExerciseCatalog {
    ...
    private static let dynamicFlexion: [Exercise] = [
        ex("classic-crunch", "Crunch contrôlé", [.upperAbs],
           ...
           setup: "Sur le dos, genoux fléchis, pieds au sol, mains posées derrière la tête sans tirer.",
           ...
           mistake: "Tirer sur la nuque avec les mains pour monter plus haut.",
           tips: ["Garde un poing d’écart entre le menton et la poitrine.",
                  "Monter haut ne sert à rien : les omoplates suffisent.",
                  "Croise les bras sur la poitrine si tu tires sur la nuque."],
           intensity: 0.9),
        ...
        ex("oblique-crunch", "Crunch oblique alterné", [.obliques, .upperAbs],
           ...
           setup: "Sur le dos, genoux fléchis, une main derrière la tête, coude bien ouvert.",
           instruction: "Rapproche une côte de la hanche opposée, puis change de côté sans tirer la tête.",
           breathing: "Expire sur chaque diagonale.",
           mistake: "Tirer avec le coude au lieu de rapprocher les côtes de la hanche.",
           tips: ["Le coude reste ouvert : il n’avance jamais vers le genou.",
                  "Pense à raccourcir un côté du ventre.",
                  "Marque un temps d’arrêt en haut."],
           side: .alternating, intensity: 1.0),
        ...
        ex("bicycle", "Bicyclette", [.obliques, .lowerAbs, .fullCore],
           ...
           setup: "Sur le dos, jambes en tablette, mains légères derrière la tête.",
           ...
           mistake: "Pédaler vite en tirant sur la nuque plutôt que de tourner le buste.",
           ...
           side: .alternating, intensity: 1.45),
