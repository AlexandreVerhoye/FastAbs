...
enum ExerciseCatalog {
    ...
    private static let antiExtension: [Exercise] = [
        ...
        ex("heel-slide", "Glissé de talon", [.deepCore, .lowerAbs],
           ...
           tips: ["Va aussi loin que le dos reste collé, pas plus loin.",
        ...
        ex("hollow-rock", "Bascule creuse", [.deepCore, .lowerAbs, .fullCore],
           ...
           instruction: "Garde la forme creuse absolument figée et fais basculer le corps d’un bloc.",
           ...
           tips: ["La forme ne change pas : c’est elle qui bascule.",
                  ...
                  "Petite amplitude : le balancement n’aide pas."],
    ...
    private static let dynamicFlexion: [Exercise] = [
        ...
        ex("v-up", "Relevé complet", [.upperAbs, .lowerAbs, .fullCore],
           family: .flexion, pattern: .dynamicFlexion, level: .advanced, motion: .vUp,
           setup: "Sur le dos, jambes tendues, bras allongés derrière la tête.",
    ...
    private static let hipExtension: [Exercise] = [
        ...
        ex("swimmer", "Nageur", [.lowerBack, .deepCore],
           ...
           tips: ["Allonge-toi vers l’avant plutôt que de monter.",
        ...
        ex("reverse-plank", "Planche inversée", [.lowerBack, .deepCore],
           ...
           breathing: "Respire calmement, sans bloquer la cage.",
           ...
           tips: ["Ouvre la poitrine : c’est ce qui contre une journée assise.",
                  "Genoux fléchis, pieds à plat, pour la version accessible.",
